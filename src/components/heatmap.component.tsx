...
import {LegendFilter, MapFilter, PercentFilter} from "../types/heatmap.type";
import {Metaverse} from "../types/metaverse.type";
import {ValuationState} from "../types/valuation.type";
import {ColorRgbToHex, RandomIntMax} from "../utils/common.util";
import {
  BLOCK_SIZE,
  BOUND_SIZE,
  CHUNK_SIZE,
  ...
  LOAD_PHRASES_LENGHT,
  TILE_SIZE
} from "../constants/heatmap.constant";

let globalFilter: MapFilter;
let globalPercentFilter: PercentFilter;
let globalLegendFilter: LegendFilter;
