...
export default function Logo({ color }: LogoProps) {
  const maksElement = useRef<SVGCircleElement>(null);
  const lightLogoElement = useRef<SVGPathElement>(null);
  const darkLogoElement = useRef<SVGPathElement>(null);
  ...
  return (
    <svg width={'100%'} height={'100%'} viewBox="0 0 250 250">
      ...
      {/* external grey logo */}
      <path ref={darkLogoElement} style={{ fill: colors[color] }} transform='translate(75, 65)'
        d="M95.728,52.103C107.852,72.203 92.731,97.281 68.483,97.281C68.483,97.281 54.699,92.21 49.997,92.21C45.295,92.21 31.511,97.281 31.511,97.281C7.309,97.281 -7.858,72.203 4.266,52.103C4.266,52.103 15.607,43.667 17.958,39.748C20.263,35.922 22.752,21.447 22.752,21.447C34.876,1.347 65.118,1.347 77.242,21.447C77.242,21.447 79.501,35.507 81.806,39.333C84.157,43.252 95.728,52.103 95.728,52.103Z"
      />
      {/* white logo with grey circle group */}
      <g clipPath='url(#svgMask)'>
        <circle cx={125} cy={125} r={125} fill={colors[color]} />
        <path ref={lightLogoElement} style={{ fill: 'white' }} transform='translate(75, 65)'
          d="M95.728,52.103C107.852,72.203 92.731,97.281 68.483,97.281C68.483,97.281 54.699,92.21 49.997,92.21C45.295,92.21 31.511,97.281 31.511,97.281C7.309,97.281 -7.858,72.203 4.266,52.103C4.266,52.103 15.607,43.667 17.958,39.748C20.263,35.922 22.752,21.447 22.752,21.447C34.876,1.347 65.118,1.347 77.242,21.447C77.242,21.447 79.501,35.507 81.806,39.333C84.157,43.252 95.728,52.103 95.728,52.103Z"
        />
      </g>
    </svg>
