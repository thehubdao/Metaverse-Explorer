            ...
            {Object.values(Metaverses).map((iterateMetaverse, index) =>
              <div key={index}>
                ...
                >
                  ...
                  {iterateMetaverse === Metaverses.Decentraland &&
                    <Image src="/images/decentraland-mana-logo.png" width={24} height={24} alt="sandbox"/>}
                  {iterateMetaverse === Metaverses.SomniumSpace &&
                    <Image src="/images/somnium-space-cube-logo.webp" width={24} height={24} alt="sandbox"/>}
                    <p className="pl-2">
                      {METAVERSE_LABEL[iterateMetaverse].toUpperCase()}
                    </p>
                </button>
