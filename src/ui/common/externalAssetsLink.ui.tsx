  ...
  return (
    <div className='h-full relative flex flex-col gap-3'>
      ...
      <Link href={land.external_link || ''} target='blank' className='relative h-full w-full'> 
        ...
        {metaverse === Metaverses.sandbox && <Image src='/images/the-sandbox-sand-logo.png' width={55} height={55} alt='sandabox' className='rounded-full p-2 bg-nm-highlight absolute bottom-3 left-3' />}
        {metaverse === Metaverses.decentraland && <Image src='/images/decentraland-mana-logo.png' width={55} height={55} alt='decentraland' className='rounded-full p-2 bg-nm-highlight absolute bottom-3 left-3' />}
        {metaverse === Metaverses['somnium-space'] && <Image src='/images/somnium-space-logo.png' width={55} height={55} alt='somniun-space' className='rounded-full p-2 bg-nm-highlight absolute bottom-3 left-3' />}
      </Link>
    </div>
  )
}