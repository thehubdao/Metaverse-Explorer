...
export default function EstimatorValuesUI({ metaverseSelected, info }: EstimatorValuesUIProps) {
  return (
    <div className="flex flex-wrap items-center justify-between py-8 mt-7">
      <div className="flex flex-col gap-y-3 w-full lg:w-1/2 text-lm-text dark:text-nm-highlight">
