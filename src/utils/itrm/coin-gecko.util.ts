...
export async function GetCoinGeckoPrices(): Promise<CoinValuesType> {
  try {
    ...
    const response = await axios.get<CoinValuesType>(`https://api.coingecko.com/api/v3/simple/price?ids=ethereum%2Cthe-sandbox%2Caxie-infinity%2Cdecentraland%2Cocean-protocol%2Cmetagamehub-dao%2Cwmatic%2Cusd-coin%2Ctether%2Csomnium-space-cubes&vs_currencies=usd`);
