...
import type { AxieLand, AxieLandInterface } from "../AxieLand";
...
export class AxieLand__factory {
  static readonly abi = _abi;
  static createInterface(): AxieLandInterface {
    return new utils.Interface(_abi) as AxieLandInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AxieLand {
    return new Contract(address, _abi, signerOrProvider) as AxieLand;
  }
}
