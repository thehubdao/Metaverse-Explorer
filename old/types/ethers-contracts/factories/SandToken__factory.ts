...
import type { SandToken, SandTokenInterface } from "../SandToken";
...
export class SandToken__factory {
  static readonly abi = _abi;
  static createInterface(): SandTokenInterface {
    return new utils.Interface(_abi) as SandTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SandToken {
    return new Contract(address, _abi, signerOrProvider) as SandToken;
  }
}
