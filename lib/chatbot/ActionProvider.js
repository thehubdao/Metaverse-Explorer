class ActionProvider {
  ...
  handleLastMessage = (amount) => {
    this.addMessageToState([
      ...
      this.createChatBotMessage('Congratulations, you just subscribed to our API using the wallet address: xxx.'),
      this.createChatBotMessage('Your subscription is valid until xx.xx.xxxx')
    ])
  }
