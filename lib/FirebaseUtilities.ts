...
export async function addLandToWatchList(
    ...
    const addToWatchListRequest = await axios.post(`/api/watchlistService/addToWatchlist?address=${address}&metaverse=${metaverse}`, land, {
        headers: {
...
export async function removeLandFromWatchList(
    ...
    const removeFromWatchListRequest = await axios.post(`/api/watchlistService/removeFromWatchList?address=${address}&metaverse=${metaverse}`, land, {
        headers: {
            'Content-Type': 'application/json',
            'Authentication': `${token}`
        }
...
export async function updateCallsCount(address:any, callsCountAdd:number,token: string){
    const updateCallsCount = await axios.post(`/api/watchlistService/updateCallsCount?address=${address}&callsCountAdd=${callsCountAdd}`,{ }, {
        headers: {
            'Content-Type': 'application/json',
            'Authentication': `${token}`
        }
...
export async function getCallsCount(address:any, token: string){
    const getCallsCount = await axios.get(`/api/watchlistService/getCallsCount?address=${address}`, {
        headers: {
            'Content-Type': 'application/json',
            'Authentication': `${token}`
        }
