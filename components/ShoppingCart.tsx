...
function ShoppingCart() {
  ...
  return (
    <>
      <button onClick={handleClick} className='flex flex-col  mx-8 mt-4 items-center justify-center rounded-xl cursor-pointer p-2 w-12 h-12 group focus:outline-none bg-[#F9FAFB] shadow-xl'>
