...
import { getBalance as BadgesContractservice } from "../../../backend/services/BadgesContractService";
...
export const Badges = () => {
  ...
  useEffect(() => {
    const getBadges = async () => {
      const badges = (
          await axios.get(
            process.env.REACT_APP_WALLETCONNECT_BACKEND_URL + "/ipfs/getPins"
          )
        ).data,
                ...
                {badges.badges.map((badge: any, index: any) => {
                  ...
                  return (
                    <>
                      <SwiperSlide>
                        <Badge
                          claim={eventTypes[Object.keys(eventTypes)[index]]}
