...
const MapCard = ({
    ...
    return errorQuery ? (
        ...
        <div className="scale-90 p-2 flex flex-col cursor-pointer max-w-sm font-plus text-grey-content items-start justify-between gap-2 bg-opacity-100 relative z-30 bg-grey-bone rounded-xl shadow-2xl">
            {loadingQuery ? (
